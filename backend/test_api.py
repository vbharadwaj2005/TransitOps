...
class TransitOpsBackendTestCase(unittest.TestCase):
    ...
    def test_trip_validations_and_lifecycle(self):
        ...
        self.assertEqual(len(expenses['data']), 1)
        self.assertEqual(expenses['data'][0]['expense_type'], 'Fuel')
        self.assertEqual(expenses['data'][0]['amount'], 24.0)
    ...
    def test_maintenance_flow(self):
        ...
        res_exp = self.client.get('/api/expenses', headers=self.manager_headers)
        expenses = json.loads(res_exp.data)
        self.assertEqual(expenses['data'][0]['expense_type'], 'Maintenance')
        self.assertEqual(expenses['data'][0]['amount'], 80.0)
